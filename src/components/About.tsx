  ...
  return (
    <section
      ...
      className={`py-16 sm:py-24 ${
        isDark
          ? "bg-gradient-to-b from-stone-900/50 to-stone-950"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-6 p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 text-white shadow-2xl shadow-orange-500/30"
            >
