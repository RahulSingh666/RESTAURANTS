      ...
      <div className="absolute inset-0">
        ...
        <div
          className={`absolute inset-0 ${
            isDark
              ? "bg-gradient-to-r from-stone-950 via-stone-950/90 to-stone-950/60"
        ...
        <div
          className={`absolute inset-0 ${
            isDark
              ? "bg-gradient-to-t from-stone-950 via-transparent to-transparent"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-2xl">
          ...
          >
            <a
              href="#menu"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-600 text-white font-semibold text-lg shadow-xl shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-[1.02] transition-all duration-300"
            >
              Explore Menu
          ...
          >
            {[
              ...
              <div key={stat.label}>
                <p
                  className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-400 to-amber-500 bg-clip-text text-transparent"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  {stat.value}
                </p>
